        ...
        train_transform = A.Compose(
            [
                ...
                A.OneOf([
                    ...
                    A.GridDistortion(p=0.33),  # Increased intensity
                ], p=0.7),
                A.OneOf([
                    A.RandomBrightnessContrast(brightness_limit=0.2, contrast_limit=0.2, p=0.33),  # Increased intensity
                ...
                A.OneOf([
                    ...
                    A.OpticalDistortion(distort_limit=2, shift_limit=0.5, p=0.33)  # Increased intensity
                ], p=0.7),
